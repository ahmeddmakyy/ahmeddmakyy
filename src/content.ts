...
const ar: SiteContent = {
  ...
  hero: {
    ...
    name: "أحمد",
    line1Post: "،",
    line2: "صانع محتوى بالـ AI ومونتير",
    quote:
  ...
  services: {
    ...
    lede: "الأول بحث، وبعدين الفكرة، وفي الآخر الإنتاج. كل براند بياخد صوت متفصل عشانه — مش قالب بنكرره 15 مرة.",
    cards: [
      {
      ...
      {
        title: "كتابة الكوبي وصوت البراند",
  ...
  work: {
    ...
    cards: [
      ...
      },
      {
        ...
        period: "تصنيع",
        title: "Como Tech",
        body: "تأسيس كامل لمصنّع أجهزة توصيلات جديد: هوية، نبرة صوت، تحليل للمنافس الكبير (57 سنة في السوق)، استراتيجية محتوى، وكتالوج 60 فكرة بنسختين استهلاكية وB2B.",
      },
      {
        tag: "رؤى وأفكار",
        period: "عربيات",
  ...
  contact: {
    eyebrow: "كلّمني",
    title: [{ t: "بتبني براند ومحتاجله " }, { t: "صوت", accent: true }, { t: "؟" }],
    lede: "احكيلي بتبني إيه — وأنا هقوللك صوته المفروض يبقى عامل إزاي.",
    whatsapp: "واتساب",
    loc: "القاهرة، مصر",
  },
  footer: "© 2026 أحمد مكي — معمولة بتوجيه نفس الأدوات اللي بستخدمها مع عملائي.",
};
